...
if (form) {
  form.addEventListener("submit", function (event) {
    event.preventDefault(); // Prevents the form's default behavior (page reload on submit)
